...
- **feedback:** Permite enviar relatos com imagem e captura de tela

### Correções

- **chat:** Organiza controles no rodapé da conversa
- **abas:** Preserva conversa ao abrir workspace após arquivo solto
...
- **colaboração:** Acompanha conversas compartilhadas pelo celular
...
- **colaboração:** Protege conteúdo compartilhado com criptografia ponta a ponta
- **alterações:** Facilita revisar diffs e preparar commits
...
- **chat:** Permite arrastar miniaturas de captura
...
- **conta:** Conecta conta opcional pelo navegador
- **projetos:** Abre os arquivos do projeto sem criar workspace
