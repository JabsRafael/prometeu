...
/// Project trust (ADR 0045): a repository's versioned `[tools]` activates only after the person
...
/// any decision, so a changed file cannot gain approval through a stale dialog (ADR 0047).
