...
export const PT = {
  ...
  "settings.plugins.body": "Skills, comandos e hooks que os agentes carregam. Cada workspace escolhe quais entram.",
  "plugin.add": "Cadastrar plugin",
  "plugin.import": "Importar do Claude Code",
  "plugin.import.none": "nada de novo para importar",
  "plugin.origin.local": "instalado nesta máquina",
  ...
  "plugin.field.source.hint": "A pasta do plugin nesta máquina, um .zip, ou o endereço de um .zip. O que você instalou com claude plugin install está em ~/.claude/plugins — o botão Importar traz cada um deles.",
  ...
  "err.plugin.notPlugin": "{path} não é um plugin — falta o .claude-plugin/plugin.json dentro dela",
