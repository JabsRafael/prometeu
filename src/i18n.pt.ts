...
export const PT = {
  ...
  "mcp.title.new": "Servidor de MCP",
  "mcp.title.edit": "Editar servidor",
  "mcp.kind.stdio": "Comando",
  "mcp.kind.url": "Endereço",
  "mcp.field.name": "Nome",
  "mcp.field.command": "Comando",
  "mcp.field.url": "URL",
  "mcp.field.env": "Variáveis e cabeçalhos",
  "mcp.field.env.hint": "CHAVE=valor, uma por linha",
  ...
  "mcp.test": "Testar",
  "mcp.testing": "conectando…",
  "mcp.test.ok": "conectou · {n} ferramentas",
  "mcp.test.okNamed": "{name} · {n} ferramentas",
  "mcp.test.empty": "conectou, mas não ofereceu ferramenta nenhuma",
  "mcp.test.auth": "precisa de login",
  "mcp.test.auth.title": "O servidor respondeu 401: o cadastro está certo, falta autenticar. Em \"Entrar\", o Prometheus se registra nele e abre o navegador para você aprovar.",
  "mcp.test.fail": "não conectou: {detail}",
  "mcp.test.failBlank": "não conectou, e o servidor não disse por quê",
  "mcp.cancel": "Cancelar",
  "mcp.save": "Salvar",
