...
export const PT = {
  ...
  "err.plugin.noPluginIn": "não há plugin nenhum em {url} — falta o .claude-plugin/plugin.json",
  ...
  "err.plugin.made.empty": "o agente terminou sem escrever o plugin.json — nada foi cadastrado",
