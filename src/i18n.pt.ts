...
export const PT = {
  ...
  "side.notes": "Notas",
  "notes.empty": "Sem notas nesta sessão.",
  "notes.emptyNoTeam": "Entre num time para trocar notas sobre a sessão.",
  "notes.write": "Escreva uma nota — @ marca alguém",
  "notes.send": "Deixar nota",
  "notes.quote.one": "Citando 1 linha do terminal",
  "notes.quote.other": "Citando {n} linhas do terminal",
  "notes.quote.drop": "Tirar a citação",
  "notes.quoteSelection": "Comentar a seleção",
  "notes.quoteSelection.title": "Nota citando o trecho selecionado no terminal  ⌘⇧M",
  ...
  "err.team.offline": "o dono está offline — o terminal não recebe tecla",
