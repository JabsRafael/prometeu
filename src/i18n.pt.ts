...
export const PT = {
  ...
  "status.awake.on": "Ligado",
  "status.awake.on.note": "Não deixa o Mac dormir nunca",
  "status.awake.agent": "Agente",
  "status.awake.agent.note": "Acordado enquanto um agente trabalha",
  "status.awake.off": "Desligado",
  "status.awake.off.note": "Deixa o Mac dormir como sempre",
  "status.res": "Recursos",
