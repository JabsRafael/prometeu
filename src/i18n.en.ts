...
export const EN: Record<keyof typeof pt.PT, string> = {
  ...
  "ws.pr": "Open PR",
  "ws.pr.offline": "the conversation is stopped — resume it before asking for the PR",
  ...
  "offline.title": "Conversation stopped",
  "offline.body":
  ...
  "side.notes": "Notes",
  "notes.empty": "No notes on this session.",
  "notes.emptyNoTeam": "Join a team to trade notes about the session.",
  "notes.write": "Write a note — @ tags someone",
  "notes.send": "Leave note",
  "notes.quote.one": "Quoting 1 line from the terminal",
  "notes.quote.other": "Quoting {n} lines from the terminal",
  "notes.quote.drop": "Drop the quote",
  "notes.quoteSelection": "Comment on the selection",
  "notes.quoteSelection.title": "Note quoting the selected text in the terminal  ⌘⇧M",
  ...
  "offline.owner.title": "{name} is offline",
  "offline.owner.body": "The conversation runs on {name}'s Mac. When they're back, the screen comes back on its own.",
  "settings.team": "Team",
  "team.title": "Team",
  ...
  "say.resuming": "resuming…",
  "say.resumed": "this conversation never spoke — we opened a new one in the same place",
  ...
  "err.team.offline": "the owner is offline — the terminal takes no keys",
  ...
  "err.session.badSettings": "invalid settings path",
  "err.session.badHook": "invalid hook path",
  "err.codex.hooks": "could not install the Codex hooks in ~/.codex/hooks.json: {err}",
