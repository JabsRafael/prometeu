...
export const EN: Record<keyof typeof pt.PT, string> = {
  ...
  "launcher.trust.title": "Trust {names}?",
  "launcher.trust.body":
    "Prometheus will start unsandboxed agents and may execute the scripts below as your user. A worktree separates Git changes; it does not limit access to your Mac.\n\n{details}",
  "launcher.trust.none": "No scripts declared; the agent will still have unrestricted access to the Mac.",
  "launcher.trust.setup": "setup: {command}",
  "launcher.trust.run": "run ({name}): {command}",
  "launcher.trust.archive": "archive: {command}",
  "launcher.trust.copy": "copy from clone: {files}",
  "launcher.trust.ok": "Trust and create",
  "launcher.trust.cancel": "Cancel",
  ...
  "err.session.noProject": "repository is not registered",
  "err.session.untrusted": "confirm trust before running this repository: {names}",
