...
export const EN: Record<keyof typeof pt.PT, string> = {
  ...
  "status.awake.on": "On",
  "status.awake.on.note": "Never lets the Mac sleep",
  "status.awake.agent": "Agent",
  "status.awake.agent.note": "Awake while an agent is working",
  "status.awake.off": "Off",
  "status.awake.off.note": "Lets the Mac sleep as usual",
