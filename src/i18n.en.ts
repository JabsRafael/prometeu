...
export const EN: Record<keyof typeof pt.PT, string> = {
  ...
  "mcp.title.new": "MCP server",
  "mcp.title.edit": "Edit server",
  "mcp.kind.stdio": "Command",
  "mcp.kind.url": "Address",
  "mcp.field.name": "Name",
  "mcp.field.command": "Command",
  "mcp.field.url": "URL",
  "mcp.field.env": "Variables and headers",
  "mcp.field.env.hint": "KEY=value, one per line",
  ...
  "mcp.test.ok": "connected · {n} tools",
  "mcp.test.okNamed": "{name} · {n} tools",
  "mcp.test.empty": "connected, but offered no tools",
  "mcp.test.auth": "needs login",
  "mcp.test.auth.title": "The server answered 401: the setup is right, authentication is missing. On \"Sign in\", Prometheus registers with it and opens the browser for you to approve.",
  "mcp.test.fail": "did not connect: {detail}",
  "mcp.test.failBlank": "did not connect, and the server did not say why",
  "mcp.cancel": "Cancel",
  "mcp.save": "Save",
  ...
  "status.awake.on.note": "Until Prometheus closes",
  "status.awake.agent": "Agent active",
  "status.awake.agent.note": "Only while an agent is working",
