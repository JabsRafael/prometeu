...
/// The board's global tool layer (ADR 0045), pushed from the board event so the defaults page can edit it.
...
/// The board's global tool layer: the base every project and workspace inherits (ADR 0045). Editing it
