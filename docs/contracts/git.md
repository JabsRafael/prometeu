...
abaixo; histórico e comparação têm navegação própria. Os grupos preservam seu
estado ao atualizar o Git. Rótulos PT-BR mantêm os termos branch, commit e stage;
