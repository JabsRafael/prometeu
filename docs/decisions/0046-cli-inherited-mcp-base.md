# ADR 0046 — The CLI's MCP set is the visible inherited base
...
ADR 0045 layered MCP, plugin and skill selection over the Prometeu hub and
...
because the strict configuration carried only hub picks. ADR 0045 accepted
