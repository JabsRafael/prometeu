# ADR 0045 — Bind tool selection to the reviewed declaration and execution provider

Date: 2026-09-15
Status: Accepted

Partially supersedes [ADR 0043](0043-layered-tool-selection.md) (Trust) and
[ADR 0044](0044-cli-inherited-mcp-base.md) (Discovery). Their other decisions
remain in force.
