...
| [0043](0043-layered-tool-selection.md) | Accepted; Authority amended by 0044, Trust superseded by 0045 | layered selection of MCP, plugins and skills across global, project and workspace |
| [0044](0044-cli-inherited-mcp-base.md) | Accepted; Discovery superseded by 0045 | the CLI's MCP set is the visible inherited base of the picker |
| [0045](0045-tool-selection-boundaries.md) | Accepted | reviewed tool declarations, effective provider and native IPC patches |
