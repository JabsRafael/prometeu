...
export default defineConfig({
  ...
  projects: [
    ...
    { name: "webkit", use: { ...devices["Desktop Safari"] }, grep: /feedback|comentário fica|segurança do compartilhamento|organizações no desktop|catálogo pessoal|a mesa|a barra lateral|design system|comando reutilizável|perfil por projeto|Code review|arquivo solto|arraste de arquivo|Git|a tela de Mudanças|file saving|finishing a save|cleanup keeps|legacy import/ },
  ],
  webServer: {
